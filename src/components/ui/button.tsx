...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary-light shadow-custom",
        ...
        hero: "bg-gradient-primary text-primary-foreground hover:shadow-accent transform hover:-translate-y-0.5 font-semibold",
        accent: "bg-accent text-accent-foreground hover:bg-accent-light shadow-accent font-medium",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-custom",
        premium: "bg-gradient-accent text-accent-foreground hover:shadow-lg transform hover:scale-105 font-semibold",
      },
      size: {
