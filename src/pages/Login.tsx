...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // In a real app, you would redirect to dashboard based on user role
    }, 1500);
  };
        ...
        <Card className="shadow-2xl border-0 bg-card/95 backdrop-blur-sm">
          <CardHeader className="text-center pb-6">
            ...
            <CardDescription className="text-muted-foreground">
              Sign in to your account to continue connecting with your alumni network
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link
                  to="/forgot-password"
                  className="text-sm text-primary hover:text-primary-light transition-fast font-medium"
                >
                  Forgot password?
                </Link>
              </div>
